<div id="<?php echo $grid->id;?>">    
    <table class="table table-striped table-bordered table-highlight <?php echo $grid->itemsCssClass;?>" current_url="<?php echo Yii::app()->request->url;?>">
      <colgroup>
