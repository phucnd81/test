<table id="<?php echo $grid->id;?>" class="table table-striped table-bordered table-highlight <?php echo $grid->itemsCssClass;?>" current_url="<?php echo Yii::app()->request->url;?>">
  <colgroup>
