...
class BaseUsers extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('licence_key, first_name1, last_name1, first_kana1, last_kana1, tel1, mobile1, email1, first_name2, last_name2, first_kana2, last_kana2, tel2, mobile2, email2, zip_code2, create_date, update_date', 'required'),
			...
			array('pref1, address1_1, address1_2, address1_3, address1_4, remark1, pref2, address2_1, address2_2, address2_3, address2_4, remark2', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, licence_key, first_name1, last_name1, first_kana1, last_kana1, tel1, mobile1, email1, zip_code1, pref1, address1_1, address1_2, address1_3, address1_4, remark1, first_name2, last_name2, first_kana2, last_kana2, tel2, mobile2, email2, zip_code2, pref2, address2_1, address2_2, address2_3, address2_4, remark2, create_date, update_date, user_type', 'safe', 'on'=>'search'),
		);
	}
