...
$pageSize = CHtml::dropDownList('pageSize',
								...
								array('onchange'=>"selectPageSizeCancel($(this).val())",
...
function selectPageSizeCancel(limit){
	$("#frmSearchCancel input[name=pageSize]").val(limit);
	$("#frmSearchCancel").submit();
}
</script>
<?php
/**
...
$this->widget('ext.spring.widgets.GridView', array(
        ...
        'no'=>"No",
        'enableSorting'=>false,
        'dataProvider'=>$model->searchDate("02"),
        'paper_sumary_before'=>'<div class="span3"><a class="btn btn-danger" href="'.Yii::app()->createUrl("contract/cancel").'">検索結果のクリア</a></div>',
        'paper_sumary_last'=>'<div class="span3 text-right">
<a class="btn btn-success" href="'.Yii::app()->createUrl("contract/CExportCSV").$query_i.'">解約データの出力</a>
        </div>',
		'page_size' => $pageSize,
        'columns'=>array(
            array(
