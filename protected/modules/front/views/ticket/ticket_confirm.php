...
<div class="header">
    <div class="page-title type-2 dark">
        <a href="shitter_regist.php"><img src="<?php echo Yii::app()->request->baseUrl; ?>/ticket/img/icn_back_a.png" alt="logo" width="52" height="52"></a>
        利用者登録
    </div>
</div><!-- ヘッダー end -->
...
<div class="container thin-header">
    ...
    <div class="user-info-box">
		...
		<div class="number-txt">チケットID</div>
        <div class="number large"><?php echo $POST['ticket_id']; ?></div>
		<div class="number-txt">settlement</div>
        <div class="number large"><?php echo $POST['settlement']; ?></div>
		
    </div>

    <div class="buttons-box mt60">
        <a href="#" onClick="return submitForm()" class="button special-h green mb5">登録</a>
        <a href="shitter_edit.php" class="button special-h grey">修正</a>
    </div>
...
<div style="display: none">
    <form id="confirmForm" method="POST">
        <input type="text" name="ticketconfirmclick" value="click">
    </form>
</div>
