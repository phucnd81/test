    ...
    <body class="light">
        ...
        <div class="header">
            <div class="page-title type-2 dark">
                <a href="post_dliving.php"><img src="<?php echo Yii::app()->request->baseUrl; ?>/ticket/img/icn_back_a.png" alt="logo" width="52" height="52"></a>
                利用者登録
            </div>
        </div><!-- ヘッダー end -->
		...
		<div class="red" style="padding-top:70px;">
			...
			<p class="p10">ticketid: <?php echo $POST['ticket_id']; ?></p>
			<p class="p10">settlement: <?php echo $POST['settlement']; ?></p>
        ...
        <div class="container thin-header">
            ...
            <form id="frm" action="" method="post">
				...
				<input type="hidden" value="<?php echo $POST['ticket_id']; ?>" name="ticket_id" id="ticket_id">
				<input type="hidden" value="<?php echo $POST['settlement']; ?>" name="settlement" id="settlement">
            </form>
