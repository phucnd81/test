...
<div id="wrapper">
	...
	<div id="container" class="clearfix">
		...
		<div class="contBox pB50 clearfix">
			<table class="areaTable">
			<thead>
			<tr>
				<th>お住まいの地域の<br>郵便番号</th>
				<th>都道府県名</th>
				<th>市区町村名</th>
				<th>ハウスクリーニング対応可否</th>
				<th>家事代行対応可否</th>
			...
			<div class="w470 fLeft">
				<h3 class="heading04">お申し込みは以下のボタンから</h3>
				<p class="talignCenter mB20"><a href="https://application.ald.smt.docomo.ne.jp/VIEW_ESITE/est/sc/main.jsp?nid=ESG401001BJP&osid=OSESG401001BJP01&svcid=C0519" target="_blank"><img src="../../images/pc/content/home/request_banner.gif" alt="ドコモオンライン手続き"></a></p>
			</div>
			
			<div class="w470 fRight">
				<h3 class="heading04">お問い合わせはこちらまで</h3>
				<p class="talignCenter mB20"><a href="#"><img src="../../images/pc/content/home/call_banner.gif" alt="0120-247-278（フリーダイヤル 24時間・年中無休）"></a></p>
			</div>
		</div>
		<!-- InstanceEndEditable -->
		</div><!--/contents-->
