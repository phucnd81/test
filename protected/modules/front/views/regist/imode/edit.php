...
<html xmlns="http://www.w3.org/1999/xhtml" >
	...
	<body class="bc-white">
		...
		<div class="header bc-gray1">
			<table>
				<tr>
					<td><a href="<?php echo Yii::app()->request->baseUrl; ?>/confirm_i.php"><img src="<?php echo Yii::app()->request->baseUrl; ?>/imode/img/icn_back_a.png" alt="←戻る" width="35" height="35"></a></td>
		...
		<div style="padding:2px;">
            ...
            <form id="frm" action="" method="post">
                ...
                <p>
                    ...
                    <input type="text" maxlength="11" class="fs-large" id="number" name="number" value="<?php echo $POST['number']; ?>">
                    <span class="fs-small">※半角数字(ハイフンなし)で入力してください。</span>
                </p>

            </form>

            <p class="ta-center mt-exlarge"><a href="javascript:goSubmitForm()"><img src="<?php echo Yii::app()->request->baseUrl; ?>/imode/img/button-next.png" alt="次へ" width="180" height="35"></a></p>
