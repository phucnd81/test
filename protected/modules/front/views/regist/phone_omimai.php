    ...
    <body class="light">
        ...
        <div class="container thin-header large-padding">
            <div class="title-box special">
                <!-- タイトル -->
                <div class="title"><img src="<?php echo $baseUrl_regist ?>img/icn_mark06.png" alt="mark" width="48" height="48"><span class="large">お見舞金</span></div>

                <!-- 説明 -->
                <div style="text-align:center">
                  <div class="caption">
                      万が一、不法侵入による破損、盗難が発生した際にお見舞金をお支払いします。<br>ご利用には事前の登録が必要です。
                  </div>
                </div>
            </div>
